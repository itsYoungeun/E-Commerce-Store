...
const SignUpPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        <h2 className="mt-6 text-center text-3xl font-exrabold text-emerald-400">
          Create Your Account
        </h2>
      </motion.div>
      <motion.div
        ...
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={ handleSubmit } className="space-y-6">
            ...
            <button
              ...
              focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition
