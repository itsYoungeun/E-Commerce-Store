    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-2">
                <div>
                    <label htmlFor="name" className="block text-sm font-medium text-gray-300 py-1">
                        Product Name
                    </label>
                    <input
                        type="text"
                ...
                <div>
                    <label htmlFor="category" className="block text-sm font-medium text-gray-300 py-1">
                        Category
                    </label>
                    <select
                        id="category"
                ...
                <div className="mt-1 flex items-center py-7">
                    <input type="file" id="image" className="sr-only" accept="image/*" onChange={handleImageChange}/>
                    <label
                        htmlFor="image"
                        className="cursor-pointer bg-gray-700 py-2 px-3 border border-gray-600 rounded-md shadow-sm text-sm
                        loading-4 font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 
